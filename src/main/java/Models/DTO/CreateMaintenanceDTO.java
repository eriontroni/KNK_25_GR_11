...
public class CreateMaintenanceDTO {
    ...
    public static boolean createMaintenance(Connection connection, int roomId, int reportedBy, String description, String status, LocalDateTime reportedAt) {
        try (PreparedStatement statement = connection.prepareStatement(INSERT_MAINTENANCE_QUERY)) {
            ...
            statement.setString(5, reportedAt.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
